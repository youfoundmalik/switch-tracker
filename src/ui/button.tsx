...
export function Button({
  ...
  return (
    <button
      className={cn(
        "w-full relative overflow-clip from-primary transition-all to-secondary gap-2 font-medium h-11 flex items-center justify-center py-2.5 px-4 text-[15px] rounded-md hover:opacity-90 ring-0",
        className,
        {
          ...
          "bg-secondary text-primary text-white": variant === "solid" && color === "secondary",
